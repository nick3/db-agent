...
export function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-[#e0e0e0] font-mono">
      ...
      {/* Header */}
      <header className="sticky top-0 z-30 border-b border-[#1a1a2e] bg-[#0a0a0f]/95 backdrop-blur-sm">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-6">
          <Link href="/admin" className="flex items-center gap-3 group">
            <div className="relative">
              <div className="absolute inset-0 bg-emerald-500/20 blur-lg group-hover:bg-emerald-500/30 transition-colors" />
            ...
            <div>
              ...
              <p className="text-[10px] uppercase tracking-[0.2em] text-[#4a4a5a]">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/"
              className="flex items-center gap-2 rounded-lg border border-[#1a1a2e] bg-[#0f0f18] px-4 py-2 text-sm text-[#8a8a9a] transition-all hover:border-emerald-500/30 hover:text-emerald-400"
            >
                  ...
                  <Link
                    ...
                    className={cn(
                      ...
                      isActive
                        ...
                        : "border-transparent hover:border-[#1a1a2e] hover:bg-[#0f0f18] text-[#6a6a7a] hover:text-[#a0a0b0]"
                    )}
                  >
                    {isActive && (
                      <motion.div
                    ...
                    <item.icon className={cn(
                      ...
                      isActive ? "text-emerald-400" : "text-[#4a4a5a] group-hover:text-[#6a6a7a]"
                    )} />
                    <div className="relative">
                      <span className={cn(
                      ...
                      <span className="block text-[10px] text-[#4a4a5a]">
                        {item.description}
                      </span>
                    </div>
                    {isActive && (
